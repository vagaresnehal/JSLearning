...
console.log(`==============================================  Array Sorting in Ascending Order of Employees ID's ==================================`);

let sortedArray1 = arrayEmployees.sort((a,b) => {
...
console.log(`==============================================  Array Sorting in Ascending Order of Employees Departments ==================================`);


let sortedArray2 = arrayEmployees.sort((a,b) => {
...
console.log(`==============================================  Array Sorting in Decending Order of Employees Salary ==================================`);


let sortedArray3 = arrayEmployees.sort((a,b) => {
